      ...
      <div className="glass overflow-hidden rounded-2xl shadow-xl border border-border">
        ...
        >
          <span className="flex items-center gap-2">
            <SlidersHorizontal className="h-3.5 w-3.5 text-primary" /> {t.testControls}
          </span>
        ...
        {open && (
          <div className="grid gap-1.5 border-t border-border p-3">
            ...
            >
              <Radio className="h-3.5 w-3.5 text-primary" /> {t.testSpeech}
            </button>
            <button
              onClick={() => simulateGesture()}
              className="flex items-center gap-2 rounded-lg bg-muted/50 px-3 py-2 text-xs font-semibold text-foreground hover:bg-muted transition-colors cursor-pointer"
            >
              <Hand className="h-3.5 w-3.5 text-amber-500" /> {t.testSign}
            </button>
            <button
            ...
            >
              <Flame className="h-3.5 w-3.5" /> {t.testFireAlarm}
            </button>
            <button
            ...
            >
              <MonitorSmartphone className="h-3.5 w-3.5" /> {view === "student" ? t.switchToTeacher : t.switchToStudent}
            </button>
          </div>
        )}
      </div>
